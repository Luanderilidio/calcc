  ...
  return (
    <div className="grid grid-cols-5 grid-rows-2 gap-2">
      ...
      onClick={() => navigate(`/projeto/${id}/${url}`)}
        ...
        className="h-[300px] flex flex-col items-start justify-between py-5 bg-cover bg-top text-white rounded-xl shadow-md shadow-black/30 relative font-Inter col-span-3 row-span-2 transition ease-in-out active:scale-95"
      >
      ...
      <div
        ...
        className=" h-full flex flex-col items-start justify-end p-2 shadow-md shadow-black/30 col-span-2 row-span-1 bg-cover bg-top rounded-xl relative transition ease-in-out active:scale-95"
      >
      ...
      <div
        ...
        className=" h-full flex flex-col items-start shadow-md shadow-black/30 justify-end p-2 col-span-2 row-span-1 bg-cover bg-top rounded-xl relative transition ease-in-out active:scale-95"
      >
        <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent rounded-b-lg" />
